...
export class GridComponent implements OnInit, OnChanges {
  ...
  public manualRowdata: FormDetails[];
  ...
  public ngOnInit() {
     this.manualRowdata = [{'selected': true, 'address': 'SUHDLO', 'contact': 4567, 'dob': '2002-12-27', 'email': 'chchh@n.co', 'firstname': 'qwe', 'lastname': 'ew', 'id': '123452345'}];
    this.gridOptions = {
